...
export const githubToken = storage.defineItem<string>('local:githubToken', { defaultValue: '' })
export const githubRepo = storage.defineItem<string>('local:githubRepo', { defaultValue: '' })
export const githubBranch = storage.defineItem<string>('local:githubBranch', { defaultValue: 'main' })
